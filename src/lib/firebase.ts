...
// Configure Firestore with long polling enabled for robust connectivity inside sandboxed iframe/proxy preview environments.
...
storage.maxUploadRetryTime = 300000; // 300 seconds instead of 120s
